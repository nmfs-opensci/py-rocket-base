...
[jupyterlab-myst](https://jupyter-book.github.io/jupyterlab-myst/) extension is installed. This is a full-featured markdown renderer. 

**Creating PDFs with Myst**

`jupyter nbconvert --to pdf test.ipynb`

TexLive packages will not install on the fly and you will need to do `tlmgr install packagename` for any missing package errors you get.
